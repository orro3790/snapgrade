...
- [Deprecated: beforeUpdate / `afterUpdate`](https://svelte.dev/docs/svelte/<#Deprecated:-beforeUpdate-afterUpdate>)
...
### Chat window example[](https://svelte.dev/docs/svelte/<#Deprecated:-beforeUpdate-afterUpdate-Chat-window-example>)
...
[ Edit this page on GitHub](https://svelte.dev/docs/svelte/<https:/github.com/sveltejs/svelte/edit/main/documentation/docs/06-runtime/03-lifecycle-hooks.md>)
previous next
[Context](https://svelte.dev/docs/svelte/</docs/svelte/context>) [Imperative component API](https://svelte.dev/docs/svelte/</docs/svelte/imperative-component-api>)
